...
## 독자 (누구를 위해 쓰나)
- 역할: AWS·AI 에이전트 실무자 (LLM · Bedrock · AgentCore · Strands 실전).
- "What is Important"는 이 역할의 *실무 영향* 관점으로 한 줄.

## 관심 토픽 (선택·랭킹 가중)
LLM · Amazon Bedrock · AgentCore · Strands · 에이전트 평가/검증 · 추론 비용/지연.

## 보이스·형식
- 차분, anti-doomscroll, Smart Brevity(스캔 가능·완결감).
- 한국어 우선(정확한 기술 용어는 영어 병기).
