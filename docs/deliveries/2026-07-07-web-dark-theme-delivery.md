...
`--panel #241a13→#31261c` (+ 위계 유지 동반 상향 `--panel-2 #2c2119→#3a2d20`·`--border #3d2f22→#4d3d2e`). 같은 토큰을 쓰는 모달·샘플 프레임·인풋도 일관되게 상향; 선택(코랄) 카드 무영향. vitest 33/33·라이브 재검증(index.html `--panel:#31261c` 서빙 확인).
