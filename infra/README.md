...
- 사용자 생성: `aws cognito-idp admin-create-user --user-pool-id us-east-1_ANfcEK61A --username <email> --user-attributes Name=email,Value=<email> Name=email_verified,Value=true` → 초대 메일(임시 비밀번호) → 첫 로그인 시 hosted UI 가 새 비밀번호 강제
